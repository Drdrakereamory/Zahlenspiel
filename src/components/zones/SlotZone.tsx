  ...
  return (
    <div className="px-5 pb-5">
      <div
        ...
        style={{
          backgroundImage: 'repeating-linear-gradient(0deg, rgba(249,115,22,0.03) 0px, transparent 2px, transparent 20px)',
        }}
      >
        ...
        <div className="text-[12px] tracking-[2px] text-text-secondary uppercase mt-1">
          {slotSpinning ? 'Spinning...' : slotDone ? 'Fate has spoken.' : 'Ready to spin'}
        </div>
      </div>
      <button
        onClick={onSpin}
        disabled={disabled}
        className="flex items-center justify-center gap-2 w-full py-[14px] bg-orange text-[#0c0c14]
